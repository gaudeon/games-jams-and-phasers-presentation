...
export default class BHPacman extends SlideAnim {
    constructor (game) {
        super(game);
        this.spriteScale = 3;
    ...
    createActors () {
        ...
        this.pacman.body.moveTo(10000, this.game.width + 600, Phaser.ANGLE_RIGHT);

        this.add(this.inky);
        this.inky.body.moveTo(12000, this.game.width + 600, Phaser.ANGLE_RIGHT);
    }
